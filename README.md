...
To run the development server install the dependencies and, in db.py, change `app.config['MYSQL_DATABASE_HOST'] = 'db'` for `app.config['MYSQL_DATABASE_HOST'] = 'locahost'`
